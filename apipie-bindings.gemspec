...
EOF
  ...
  # lower versions don't allow setting infinite timeouts, higher versions have different api
  # 1.7.0 and 1.8.0 use mime-types < 3.3.1, which is not compatible with Ruby 2.7+
  s.add_dependency 'rest-client', '>= 1.6.5', '< 3.0.0', '!= 1.7.0', '!= 1.8.0'
